...
public class Jsoup {
    ...
    /**
     ...
     @see Cleaner#clean(org.jsoup.nodes.Document)
     */
     ...
     * existing document. If you want to clean full documents, use {@link Cleaner#clean(org.jsoup.nodes.Document)} instead, and add
