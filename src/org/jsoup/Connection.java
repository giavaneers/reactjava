...
public interface Connection {
     ...
     * @see #data(String, String, java.io.InputStream, String) if you want to set the uploaded file's mimetype.
     */
    Connection data(
       String key,
       String filename,
    ...
    interface Request extends Base<Request> {
         ...
         * @see #sslSocketFactory(javax.net.ssl.SSLSocketFactory)
         */
    ...
    interface Response extends Base<Response> {
         ...
         * @return this response, for chaining
         * @throws org.jsoup.UncheckedIOException if an IO exception occurs during buffering.
         */
        Response bufferUp();
    ...
    interface KeyVal {
         ...
         * Only useful if {@link #inputStream(java.io.InputStream)} is set.
