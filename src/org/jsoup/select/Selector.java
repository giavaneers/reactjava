 ...
 * <tr><td><code>:not(<em>selector</em>)</code></td><td>elements that do not match the <em>selector</em>. See also {@link org.jsoup.select.Elements#not(String)}</td><td><code>div:not(.logo)</code> finds all divs that do not have the "logo" class.<p><code>div:not(:has(div))</code> finds divs that do not contain divs.</p></td></tr>
...
public class Selector {
     ...
     * @throws org.jsoup.select.Selector.SelectorParseException (unchecked) on an invalid CSS query.
     */
