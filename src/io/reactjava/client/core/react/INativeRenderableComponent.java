...
name:       INativeRenderableComponent - native functional component
...
purpose:    Defines a stateless ReactJava component expressed as a plain function.
            ...
            in the future ReactJava will be able to make performance optimizations
            specific to these components by avoiding unnecessary checks and
            memory allocations. This is the recommended pattern, when possible.
...
@JsFunction
public interface INativeRenderableComponent<P extends Properties>
{
/*------------------------------------------------------------------------------
