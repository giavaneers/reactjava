   ...
   int testNum)
{
   String[] expectedResults =
   {
      ...
      "public void render() { int a = 0; } ",
                                       // test 5                              //
      "public void render() {java.util.Stack<io.reactjava.client.core.react.ElementDsc> parents=new java.util.Stack<>();io.reactjava.client.core.react.ElementDsc root = null;io.reactjava.client.core.react.ElementDsc elem;elem =io.reactjava.client.core.react.ElementDsc.create(parents.size() > 0 ? parents.peek() : null,ReactJava.getRenderableComponent(\"A\"),new A(Properties.with(\"id\", getNextId())).props());root = root == null ? elem : root;parents.push(elem);elem =io.reactjava.client.core.react.ElementDsc.create(parents.size() > 0 ? parents.peek() : null,ReactJava.getRenderableComponent(\"B\"),new B(Properties.with(\"id\", getNextId())).props());root = root == null ? elem : root;parents.pop();elem =io.reactjava.client.core.react.ElementDsc.create(parents.size() > 0 ? parents.peek() : null,ReactJava.getRenderableComponent(\"B\"),new B(Properties.with(\"id\", getNextId())).props());root = root == null ? elem : root;parents.push(elem);elem =io.reactjava.client.core.react.ElementDsc.create(parents.size() > 0 ? parents.peek() : null,\"span\",Properties.with(\"id\", getNextId()),\" \");root = root == null ? elem : root;parents.pop();} ",
                                       // test 6                              //
