   ...
   TreeLogger         logger)
{
   ...
   if (bBodyPart)
   {
      ...
      else
      {
         ...
         write(
            buf,
            "io.reactjava.client.core.react.ReactJava.getRenderableComponent(\""
          + componentClassname
          + "\"),");
   ...
   int testNum)
{
   String[] expectedResults =
   {
      ...
      "public void render() { int a = 0; } ",
                                       // test 5                              //
      "public void render() {java.util.Stack<io.reactjava.client.core.react.ElementDsc> parents=new java.util.Stack<>();io.reactjava.client.core.react.ElementDsc root = null;io.reactjava.client.core.react.ElementDsc elem;elem =io.reactjava.client.core.react.ElementDsc.create(parents.size() > 0 ? parents.peek() : null,ReactJava.getRenderableComponent(\"A\"),new A(Properties.with(\"id\", getNextId())).getProperties());root = root == null ? elem : root;parents.push(elem);elem =io.reactjava.client.core.react.ElementDsc.create(parents.size() > 0 ? parents.peek() : null,ReactJava.getRenderableComponent(\"B\"),new B(Properties.with(\"id\", getNextId())).getProperties());root = root == null ? elem : root;parents.pop();elem =io.reactjava.client.core.react.ElementDsc.create(parents.size() > 0 ? parents.peek() : null,ReactJava.getRenderableComponent(\"B\"),new B(Properties.with(\"id\", getNextId())).getProperties());root = root == null ? elem : root;parents.push(elem);elem =io.reactjava.client.core.react.ElementDsc.create(parents.size() > 0 ? parents.peek() : null,\"span\",Properties.with(\"id\", getNextId()),\" \");root = root == null ? elem : root;parents.pop();} ",
                                       // test 6                              //
      ...
      switch(testNum)
      {
         ...
         case 1:
         {
            ...
            content =
             ...
             + "                 onClick=getProperties().get(\"signUpHandler\")\n"
             ...
             + "              <@material-ui.core.Button\n"
             + "                 variant='contained' fullWidth\n"
             + "                 onClick=getProperties().get(\"signInHandler\")\n"
         ...
         case 6:
         {
            javaBlock =
             ...
             + "if (getProperties().getBoolean(\"login\"))\n"
             + "{\n"
            ...
            content =
             ...
             + "/*--\n"
             + "\n\n\n\n"
             + "<button class={buttonClass} onClick=getProperties().get(\"onClick\")>\n"
         ...
         case 8:
         {
            ...
            content =
             ...
             + "   /*--\n"
             + "   <SubBoardView\n"
             + "      board={getProperties().get(App.kKEY_BOARD)}\n"
             + "      subBoardIndex={i}\n"
             + "      key={i}\n"
             + "      moveFcn={getProperties().get(App.kKEY_MOVE_FCN)}\n"
             + "   >\n"
             + "   </SubBoardView>\n"
             + "   --*/\n"
             + "}\n"
